import {top, left, right, bottom, start} from "../../../unoptimized/lib/enums.js";
...
import getAltAxis2 from "../../../unoptimized/lib/utils/getAltAxis.js";
import within2 from "../../../unoptimized/lib/utils/within.js";
...
function preventOverflow(_ref) {
  ...
  if (checkMainAxis || checkAltAxis) {
    ...
    if (checkMainAxis) {
      var preventedOffset = within2(tether ? mathMin(min, tetherMin) : min, offset, tether ? mathMax(max, tetherMax) : max);
    ...
    if (checkAltAxis) {
      ...
      var _preventedOffset = within2(tether ? mathMin(_min, tetherMin) : _min, _offset, tether ? mathMax(_max, tetherMax) : _max);
