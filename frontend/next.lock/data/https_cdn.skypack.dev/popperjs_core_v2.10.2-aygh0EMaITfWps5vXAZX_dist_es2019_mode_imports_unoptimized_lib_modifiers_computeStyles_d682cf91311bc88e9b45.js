import {top, left, right, bottom, end} from "../../../unoptimized/lib/enums.js";
...
import {round} from "../../../unoptimized/lib/utils/math.js";
var unsetSides = {
  top: "auto",
  right: "auto",
  bottom: "auto",
...
export function mapToStyles(_ref2) {
  ...
  var win = window;
  if (adaptive) {
    var offsetParent = getOffsetParent2(popper);
    var heightProp = "clientHeight";
    var widthProp = "clientWidth";
    if (offsetParent === getWindow2(popper)) {
      offsetParent = getDocumentElement2(popper);
