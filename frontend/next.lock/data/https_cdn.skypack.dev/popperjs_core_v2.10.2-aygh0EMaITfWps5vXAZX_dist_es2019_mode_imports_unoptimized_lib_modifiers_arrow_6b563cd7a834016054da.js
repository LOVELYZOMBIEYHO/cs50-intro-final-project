...
import {left, right, basePlacements, top, bottom} from "../../../unoptimized/lib/enums.js";
import {isHTMLElement} from "../../../unoptimized/lib/dom-utils/instanceOf.js";
var toPaddingObject = function toPaddingObject2(padding, state) {
  padding = typeof padding === "function" ? padding(Object.assign({}, state.rects, {
    placement: state.placement
  })) : padding;
  return mergePaddingObject2(typeof padding !== "number" ? padding : expandToHashMap2(padding, basePlacements));
};
function arrow(_ref) {
  ...
  var offset = within2(min, center, max);
  var axisProp = axis;
